...
def mogEM(x, K, iters, randConst=1, minVary=0):
    ...
    #------------------- Answers ---------------------
    # Kmeans with k = 7 for five iterations
    # Uncomment for Q4.3
    # mu = KMeans(x, 7, 5)
    #------------------------------------------------------------
...
def q2():
    ...
    #------------------- Add your code here ---------------------
    mixing_coeff, mean, variance, log_likelihood = mogEM(inputs_train, K, iters, randConst = randConst, minVary = minVary)
    
    #------------------- Answers ---------------------

    ShowMeans(mean)
    ShowMeans(variance,1)
